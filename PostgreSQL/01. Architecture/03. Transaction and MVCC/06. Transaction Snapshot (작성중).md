...
4. Session 4개를 2,3,4,1번 순서대로 커밋하면서 각 트랜잭션 레벨 별로 스냅샷, 데이터 조회하기
 - Read Uncommitted
   ...
   | Session#2 커밋 | 584:590:584,588  | 2|
   | Session#3 커밋 |  584:590:584 | 2,3|
   | Session#4 커밋 | 584:591:584 | 2,3,4 |
   | Session#1 커밋 | 591:591: |1,2,3,4 |
- Read Committed
...
- Repeatable Read
   ...
   | --- | --- | --- |
   | 초기 |584:590:584,586,588 | X |
   | Session#2 커밋 | 584:590:584,586,588 | X |
   | Session#3 커밋 |  584:590:584,586,588 |x |
   | Session#4 커밋 |584:590:584,586,588 |x |
   | Session#1 커밋 | 584:590:584,586,588|x |
- Serializable
