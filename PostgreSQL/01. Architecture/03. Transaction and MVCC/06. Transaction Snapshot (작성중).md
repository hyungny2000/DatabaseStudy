...
-----+-------------+--------------------------------------
 ...
 424 |             | select pid, backend_xid, query      +
     |             | from pg_stat_activity               +
     |             | where backend_type='client backend';
```
...
4. Session 4개를 2,3,4,1번 순서대로 커밋하면서 각 트랜잭션 레벨 별로 스냅샷, 데이터 조회하기
 - Read Uncommitted
   ...
   | Session#2 (584) 커밋 | 584:590:584,588  | 2|
   | Session#3 (586) 커밋 |  584:590:584 | 2,3|
   | Session#4 (588) 커밋 | 584:591:584 | 2,3,4 |
   | Session#1 (590) 커밋 | 591:591: |1,2,3,4 |
   - PostgreSQL에서는 공식적으로 Read Uncommitted 격리레벨을 지원하지 않는다. 모든 트랜잭션이 진행중인(Uncommitted) 상황에서도 어떤 데이터도 조회되지 않고, Read Committed격리레벨처럼 동작한다.
...
- Repeatable Read
   ...
   | --- | --- | --- |
   | 초기 |584:590:584,586,588 | X |
   | Session#2 (584) 커밋 | 584:590:584,586,588 | X |
   | Session#3 (586) 커밋 |  584:590:584,586,588 |x |
   | Session#4 (588) 커밋 |584:590:584,586,588 |x |
   | Session#1 (590) 커밋 | 584:590:584,586,588|x |
- Serializable
