...
nano=# select ctid, xmin, xmax, col1 from test1;
 ctid  | xmin | xmax | col1
-------+------+------+------
<<<<<<< HEAD:PostgreSQL/01. Architecture/03. Transaction and MVCC/04. infomask의 XMIN,XMAX 상태변화 확인.md
 (0,1) |  576 |    0 |    1
=======
 (0,1) |  547 |    0 |    1
(1 row)
>>>>>>> dceb96ba225e33bdc5698be8c90e417db3f29a73:PostgreSQL/01. Architecture/03. Transaction and MVCC/04. infomask의 XMIN,XMAX 상태변화 확인 (작성중).md
```
- 아까와 다르지 않음.
