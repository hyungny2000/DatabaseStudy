...
| 0x0050 | 0000000001010000 | HEAP_XMAX_SHR_LOCK (HEAP_XMAX_EXCL_LOCK|HEAP_XMAX_KEYSHR_LOCK) | XMAX가 공유모드 잠금을 나타냄. |
| 0x0050 | 0000000001010000 | HEAP_LOCK_MASK (HEAP_XMAX_SHR_LOCK|HEAP_XMAX_EXCL_LOCK|HEAP_XMAX_KEYSHR_LOCK) | XMAX가 공유모드 잠금을 나타냄 | 
...
| 0x0600 | 0000001100000000 | HEAP_XMIN_FROZEN (HEAP_XMIN_COMMITTED|HEAP_XMIN_INVALID) | t_xmin이 Frozen 상태임 (Vacuum Freeze된 상태) |
...
| 0xC000 | 1100000000000000 | HEAP_MOVED | (HEAP_MOVED_OFF|HEAP_MOVED_IN) 튜플이 이동됨 |
