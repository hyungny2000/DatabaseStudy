...
4. 마스터 노드의 repmgr 설정
   ...
   4. repmgr 계정을 non-superuser로 생성하고 권한 부여
   2. repmgr 계정을 소유주로 하여 repmgr 데이터베이스 생성
   5. pg_hba.conf파일에 repmgr 계정 관련 접속권한 부여 (trust가 아닌 md5 인증방식 사용)
   6. archive_mode=always, archive_command 설정. archive 디렉토리 생성
