...
```
## VIP Add
## check whether this node is primary or not
## select type from nodes where node_name='hostname';
## if type == 'primary' then add VIP or Pass
## 
## (pseudo code)
## node_type = 'select type from nodes where node_name='hostname';
##
...
## apply .repmgr_env environment variables
. .repmgr_env
