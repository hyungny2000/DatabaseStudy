...
- 1번 노드에서 Insert시 테이블 데이터
   | col1 | col2 |
   | :---: | :---: |
   | 1 | inserted from node#1 |
   | 3 | inserted from node#1 |
   | 5 | inserted from node#1 |
- 1번 노드 장애로 2번 노드에서 Insert시 테이블 데이터
   | col1 | col2 |
   | :---: | :---: |
   | 1 | inserted from node#1 |
   | 3 | inserted from node#1 |
   | 5 | inserted from node#1 |
   | 2 | inserted from node#2 |
   | 4 | inserted from node#2 |
   | 6 | inserted from node#2 |
   | 8 | inserted from node#2 |
   | 10 | inserted from node#2 |
- 다시 1번 노드에서 Insert시
   | col1 | col2 |
   | :---: | :---: |
   | 1 | inserted from node#1 |
   ...
   | 8 | inserted from node#2 |
   | 10 | inserted from node#2 |
   | 7 | inserted from node#1 |
   | 9 | inserted from node#1 |
   | 11 | inserted from node#1 |
