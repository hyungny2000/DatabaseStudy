...
select * from pg_stat_subscription;select * from pg_stat_subscription;
-[ RECORD 1 ]---------+------------------------------
subid                 | 16399
subname               | my_sub2
pid                   | 162
leader_pid            |
relid                 |
received_lsn          | 0/1973C20
last_msg_send_time    | 2025-03-18 23:36:29.334033+00
last_msg_receipt_time | 2025-03-18 23:36:29.350103+00
latest_end_lsn        | 0/1973C20
latest_end_time       | 2025-03-18 23:36:29.334033+00
...
leader_pid            |
relid                 |
received_lsn          | 0/1975858
last_msg_send_time    | 2025-03-18 23:36:21.174438+00
last_msg_receipt_time | 2025-03-18 23:36:21.174696+00
latest_end_lsn        | 0/1975858
latest_end_time       | 2025-03-18 23:36:21.174438+00
```
- subscription이 생성되는 시점에 publication 노드에 subscription id를 따와서 origin을 만듦
  - subid : 16399
  - origin : pg_16399
...
2. postlr01 데이터 Insert
    ...
    (7 rows)
    ```
    - 홀수 번호(5,7,9)를 채번하여 데이터 Insert 성공.
...
3. postlr02 데이터 Insert
    ...
    (10 rows)
    ```
    - 짝수 번호(6,8,10)를 채번하여 데이터 Insert 성공.
